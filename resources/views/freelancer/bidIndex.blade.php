                    ...
                    <tbody>
                        @forelse($bids as $bid)
                            <tr>
                                ...
                                <td>{{ $bid->status }}</td>
                                <td>
                                    <a href="{{ route('freelancer.bids.show', $bid->id) }}" class="btn btn-info btn-sm">View</a>
                                    <a href="{{ route('freelancer.bids.edit', $bid->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="{{ route('freelancer.bids.destroy', $bid->id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
